  ...
  <div>
    ...
    <el-table :data="information.slice((currentPage-1)*pageSize,currentPage*pageSize)"
      ...
      <el-table-column label="操作" width="120">
        <template slot-scope="scope">
          <el-button type="text" size="big" @click="VerifiedInfo(scope.row.id)">验证</el-button>
        </template>
      </el-table-column>
    </el-table>
    <br>
    ...
    export default {
        ...
        methods: {
          ...
          listDisable() {
            ...
            let that = this
            this.$http.get("http://localhost:9001/infoImage-api/admin/infoimage/disable?page=1&pagesize=100",
              {
          ...
          VerifiedInfo:function (id) {
            ...
            this.$http.put("http://localhost:9001/infoImage-api/admin/infoimage/"+id,formData,{
              ...
              if(res.data.status === 'success'){
                alert('验证成功')
                this.$router.push('/backToDisableImage')
              }
            })
          }
        },
