    ...
    <div>
      ...
      >
        ...
        <el-submenu index="2">
          ...
          <el-menu-item index="2-2"><a href="/listMyPark">我提交的停车场</a></el-menu-item>
          <el-menu-item index="2-3"><a href="/listDisablePark">已禁用的停车场</a></el-menu-item>
          <el-menu-item index="2-4"><a href="/listNoVerifiedPark">未验证的停车场</a></el-menu-item>
          <el-menu-item index="2-5"><a href="/listVerifiedPark">已验证的停车场</a></el-menu-item>
          <el-menu-item index="2-6"><a href="/addstate">添加停车场状态</a></el-menu-item>
          <el-menu-item index="2-7"><a href="/addparking">添加停车场</a></el-menu-item>
        </el-submenu>
        <el-submenu index="3">
...
<!--        <el-menu-item index="6"><i class="el-icon-s-custom"/><a href="/login">登录</a></el-menu-item>-->
                <el-menu-item index="6"><i class="el-icon-s-custom"/><a href="/login">退出</a></el-menu-item>
      </el-menu>
      <router-view/>
    </div>
</template>
